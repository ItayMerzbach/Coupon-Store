...
public class Coupon {
	 ...
	 * CONTRUCTOR
	 */
	public Coupon(long idCompany, String title, Date startDate, Date endDate, int amount,
			String couponType, String message, double price, String image) {
		super();
	...
	public Coupon(long idCoupon, long idCompany, String title, Date startDate, Date endDate, int amount,
			String couponType, String message, double price, String image) {
		this( idCompany, title,  startDate,  endDate,  amount, couponType,  message,  price,  image);
